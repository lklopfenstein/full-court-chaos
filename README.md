...
- Free on-device photo-to-sprite conversion using browser-based person segmentation, uniform tinting, background removal, posterization, dithering, hard outlining, and nearest-neighbor scaling
